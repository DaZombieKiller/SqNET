...
namespace Squirrel
{
    ...
    {
        [DllImport(DllName, EntryPoint = "sq_getfunctioninfo", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(DllName, EntryPoint = "sq_setdebughook", CallingConvention = CallingConvention.StdCall)]
        extern public static void SetDebugHook(IntPtr v);

        [DllImport(DllName, EntryPoint = "sq_setnativedebughook", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(DllName, EntryPoint = "sq_stackinfos", CallingConvention = CallingConvention.StdCall)]
