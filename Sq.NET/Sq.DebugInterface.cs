...
namespace Squirrel
{
    ...
    {
        [DllImport(DllName, EntryPoint = "sq_getfunctioninfo")]
        ...
        [DllImport(DllName, EntryPoint = "sq_setdebughook")]
        extern public static void SetDebugHook(IntPtr v);

        [DllImport(DllName, EntryPoint = "sq_setnativedebughook")]
        ...
        [DllImport(DllName, EntryPoint = "sq_stackinfos")]
